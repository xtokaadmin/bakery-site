...
const Footer = () => {
  return (
    <footer className="bg-[#fdefef] text-stone-800 py-12 px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <p>Bernstrasse 61, 4852 Rothrist</p>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <p>info@baeckerei-waelchli.ch</p>
            </div>
            <div className="pt-2">
              <h4 className="text-sm font-medium mb-2">Öffnungszeiten</h4>
              <p className="text-sm">Montag - Freitag: 06:00 -  18:30</p>
              <p className="text-sm">Samstag: 6:00 - 16:00</p>
              <p className="text-sm">Sonntag: 8:00 - 12:00</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#e40062] hover:bg-[#f58f8f] text-white text-white p-2 rounded-full  transition-colors"
              >
